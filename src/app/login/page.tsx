...
import { LanguageSwitcher } from '@/components/shared/LanguageSwitcher'; // Added to allow language change on login page
import Link from 'next/link';
import { useLanguage } from '@/contexts/LanguageContext'; // Import for t function if needed directly here, or rely on LoginForm


export default function LoginPage() {
  // const { t } = useLanguage(); // If you need t directly in this page component
  return (
